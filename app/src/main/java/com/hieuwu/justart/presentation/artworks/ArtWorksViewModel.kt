...
class ArtWorksViewModel @Inject constructor(private val retrieveArtWorksUseCase: RetrieveArtWorksUseCase) :
    ...
    init {
        _artWorksList.value = listOf(
            ArtWork(
                28560, "Starry Night and the Astronauts",
            ...
            ArtWork(
                2, "Buddha Shakyamuni Seated in Meditation (Dhyanamudra)",
            ...
            ArtWork(
                4, "A Sunday on La Grande Jatte — 1884",
